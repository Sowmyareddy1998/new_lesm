...
//			}
				...
				profit_or_loss = (Double) lc.lead_cal(Employeeid.getEmpId(), fromDate, toDate);
		...
		Double Total_profit_or_loss = sub_profit + bc.Employee_cal(ManagerEmployeeId, fromDate, toDate);
