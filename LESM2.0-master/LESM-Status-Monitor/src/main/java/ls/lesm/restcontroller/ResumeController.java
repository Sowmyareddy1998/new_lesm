...
public class ResumeController {
	...
	public ResponseEntity<?> uploadingFile(@RequestParam MultipartFile file, @RequestParam String id, Principal principal) throws IOException
			 {
...
//	
	...
	public ResponseEntity<Resource> downloadFile(@RequestParam String lancesoft) throws Exception {
		...
		Attachment attachment = attachmentRepo.findBymasterEmployeeDetails_Id(employeeDetails.getEmpId()).get();
	...
	public ResponseEntity<?> updatingFile(@RequestParam MultipartFile file, @RequestParam String id,
		...
		return new ResponseEntity("resume with this not present", HttpStatus.INTERNAL_SERVER_ERROR);
